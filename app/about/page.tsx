        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">
              About <span className="text-white">Pro Craftworks</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-100 rounded-lg p-8">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-black mb-4">18 Years Strong</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-black mb-4">Our Mission & Approach</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold text-black mb-4">Think Outside the Box</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-xl font-semibold text-black mb-4">Your Vision, Our Expertise</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              <div className="text-4xl mb-4">⚡</div>
              <h3 className="text-xl font-semibold text-black mb-4">European Craftsmanship</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">Residential</h3>
            ...
            <div className="text-center p-6">
              <div className="text-6xl mb-4">🏢</div>
              <h3 className="text-2xl font-bold text-black mb-4">Commercial</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="text-center p-6">
              <div className="text-6xl mb-4">🔨</div>
              <h3 className="text-2xl font-bold text-black mb-4">Custom</h3>
              <p className="text-gray-600 mb-4">
